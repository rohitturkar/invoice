    ...
    <div className="flex  justify-center items-center h-screen ">
      ...
      >
        ...
        <div className="flex flex-col mb-6 gap-2 items-center justify-center ">
            ...
            <p className="text-sm ">Please Enter Your User Information To Login.</p>
          </div>
          ...
          <div className="flex flex-col gap-2  ">
            <Field
              name="email"
              type="email"
              className="p-2 rounded-xl border w-[100%]"
...
<div
          ...
          <div className="text-gray-700 mt-2 text-center font-medium text-sm">
            Don't have an account? <a className='text-gray-900 font-semibold cursor-pointer' href="/signup">Register</a>
          </div> 
